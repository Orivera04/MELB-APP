...
function ControlesLecturaEscritura(Cond) {
    if (Cond == true) {
        ...
        $('#SexoEstudiante').prop('disabled', 'true'); SexoEstudiante
        $('.selectpicker').selectpicker('refresh');
