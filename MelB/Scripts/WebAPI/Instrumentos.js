...
/* Funciones de soporte */
        ...
        function Grafica_Instrumentos()
        {
          var ContextoInstrumentos = document.getElementById("GraficaInstrumentos").getContext("2d");
          var donut = new Chart(ContextoInstrumentos)(
            [
              {
                value: 300,
                color:"#F7464A",
